...
public class NewSubscriptionWrapper<K, V> {
    ...
    public NewSubscriptionWrapper(final long[] hash, final Instruction instruction, final K primaryKey, final Integer primaryPartition, V messageValue) {
        this(hash, instruction, primaryKey, CURRENT_VERSION, messageValue, primaryPartition);
    }

    public NewSubscriptionWrapper(final long[] hash, final Instruction instruction, final K primaryKey, final byte version, V messageValue, final Integer primaryPartition) {
        ...
        Objects.requireNonNull(messageValue, "messageValue cannot be null. Required by downstream processor.");
    ...
    public boolean equals(final Object o) {
        ...
        final NewSubscriptionWrapper<?,?> that = (NewSubscriptionWrapper<?,?>) o;
